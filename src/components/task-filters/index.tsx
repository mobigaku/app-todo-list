...
import { Priority, Status, Category } from "@/src/types/prisma";
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <Select
          ...
          onValueChange={(value: Priority | "all") => setPriority(value)}
        >
          <SelectTrigger className="w-[180px]">
            ...
            <PopoverTrigger asChild>
              ...
              >
                ...
                {filters.dateRange.startDate ? (
                  format(new Date(filters.dateRange.startDate), "PPP", {
                    locale: ptBR,
                  })
                ) : (
            ...
            <PopoverTrigger asChild>
              ...
              >
                ...
                {filters.dateRange.endDate ? (
                  format(new Date(filters.dateRange.endDate), "PPP", {
                    locale: ptBR,
                  })
                ) : (
